...
from Baseline_NoneEditing import Baseline_NoneEditingHyperParams
...
ALG_DICT = {
    ...
    "Baseline_NoneEditing": (Baseline_NoneEditingHyperParams, apply_Baseline_NoneEditing_to_model ),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--alg_name",
        choices=["AlphaEdit", "AlphaEdit_Hessian", "Baseline_NoneEditing", "MEMIT_rect", "MEMIT_seq","MEMIT_prune", "MEMIT", "ROME", "FT", "MEND","NSE"],
        default="ROME",
